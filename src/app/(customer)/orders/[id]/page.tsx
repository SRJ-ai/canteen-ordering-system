...
export default function OrderTrackingPage() {
  ...
  useEffect(() => {
    fetchOrder();
    // Auto-poll every 5 seconds for live status changes
    ...
    return (
      <div className="max-w-md mx-auto py-16 text-center space-y-4">
        ...
        <p className="text-xs text-muted-foreground">
          We couldn&apos;t find an order with reference ID: {orderId}
        </p>
        <Link href="/menu">
  ...
  // Customers can only cancel when PENDING or CONFIRMED
